...
<div class="container">
        ...
        <div class="cards">
            ...
            <div class="card">
                <img src="auto_loan.png" alt="Auto Loan Promo">
            ...
            <div class="modal fade" id="learnMoreModal-AutoLoanPromo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <img src="auto_loanmodal.png" alt="Home Loan">
            ...
            <!-- Home Loan Card -->
            <div class="card">
                <img src="home_loan.png" alt="Home Loan">
            ...
            <div class="modal fade" id="learnMoreModal-HomeLoan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <img src="home_loanmodal.png" alt="Home Loan">
            ...
            <!-- SME Loan Card -->
            <div class="card">
                <img src="sme_loan.png" alt="SME Loan">
            ...
            <div class="modal fade" id="learnMoreModal-SMELoan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <img src="sme_loanmodal.png" alt="SME Loan">
            ...
            <!-- Personal Loan Card -->
            <div class="card">
                <img src="personal_loan.png" alt="Personal Loan">
    ...
    <div class="container2">
        ...
        <div class="cards-carousel2">
            ...
            <div class="cards2">
                <div class="card2">
                    <img src="breeze_residences.png" alt="Breeze Residences">
                        ...
                        <div class="modal fade" id="breezeModal" tabindex="-1" aria-labelledby="breezeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2><p align="center">Real Estate Property<br> Requirements for <br>CONDO UNITS</h2></p>
                                        <img src="breeze_residencesmodal.png" alt="Salcedo Square">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Owners Copy of Condominium Title.</li>
                ...
                <div class="card2">
                    <img src="coast_residences.png" alt="Coast Residences">
                    <div class="card-content2">
                        ...
                        <div class="modal fade" id="coastModal" tabindex="-1" aria-labelledby="coastModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <h2><p align="center">Real Estate Property<br> Requirements for <br>CONDO UNITS</h2></p>
                                    <img src="coast_residencesmodal.png" alt="Salcedo Square">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Owners Copy of Condominium Title.</li>
                ...
                <div class="card2">
                    <img src="salcedo_square.png" alt="Salcedo Square">
                    <div class="card-content2">
                        ...
                        <div class="modal fade" id="salcedoModal" tabindex="-1" aria-labelledby="salcedoModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <h2><p align="center">Real Estate Property<br> Requirements for <br>CONDO UNITS</h2></p>
                                    <img src="salcedo_squaremodal.png">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Owners Copy of Condominium Title.</li>
    ...
    <div class="container3">
        ...
        <div class="carousel3">
            ...
            <div class="cards3">
                <div class="card3">
                    <img src="bmw_318i.png" alt="BMW 318i">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <img src="bmw_318imodal.png" alt="Salcedo Square">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                ...
                <div class="card3">
                    <img src="bmw_530i.png" alt="BMW 530i">
                    <div class="card-content3">
                        ...
                        <div class="modal fade" id="bmw530iModal" tabindex="-1" aria-labelledby="bmw530iModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2><p align="center">Motor Vehicles Requirements</h2></p>
                                        <img src="bmw_530imodal.png" alt="BMW 530i">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Photocopies of OR/CR(2 copies)</li>
                        ...
                        <div class="modal fade" id="bydDolphinModal" tabindex="-1" aria-labelledby="bydDolphinModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2><p align="center">Motor Vehicles Requirements</h2></p>
                                        <img src="byd_dolphinmodal.png" alt="BYD Dolphin">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Photocopies of OR/CR(2 copies)</li>
                ...
                <div class="card3">
                    <img src="gac_empow.png" alt="GAC Empow">
                    <div class="card-content3">
                        ...
                        <div class="modal fade" id="gacEmpowModal" tabindex="-1" aria-labelledby="gacEmpowModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2><p align="center">Motor Vehicles Requirements</h2></p>
                                        <img src="gac_empowmodal.png" alt="GAC Empow">
                                        ------------------------------------------------------------------------
                                        <br><h3>Primary</h3>
                                        <ul>
                                        <li>Photocopies of OR/CR(2 copies)</li>
