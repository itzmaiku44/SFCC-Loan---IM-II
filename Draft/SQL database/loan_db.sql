...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2024 at 08:32 AM
...
CREATE TABLE `application` (
  ...
  `directorStatus` varchar(25) NOT NULL,
  `presidentStatus` varchar(25) NOT NULL,
  `collectorStatus` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `application` (`id`, `fname`, `lname`, `age`, `bmonth`, `bday`, `byear`, `phonenum`, `email`, `street1`, `street2`, `city`, `province`, `postal`, `country`, `loanAmount`, `term`, `fundPurpose`, `applyDate`, `applicationStatus`, `remark`, `directorStatus`, `presidentStatus`, `collectorStatus`) VALUES
(1, 'Michael', 'James', 22, 12, 13, 2001, 9267291085, 'jordan23@gmail.com', 'home blk.69', 'Grove St.', 'Los Santos', 'San Andreas', 42069, 'United States', 100000, '6 Months', 'Weed and coke', '2024-06-23 17:14:20', 'Pending', NULL, '', '', ''),
(2, 'paulo', 'seres', 37, 1, 1, 1987, 9123456878, 'hawktuah@gmail.com', 'lower nasipit', 'Talamban', 'Cebu', 'Cebu', 6000, 'Philippines', 4206969, '24 Months', 'Suyop', '2024-06-23 19:01:15', 'Pending', NULL, '', '', '');
