<?php
    ...
    $sql = "SELECT * FROM approvedsPr LIMIT $start_from, $rows_per_page";
    ...
    $sql_total = "SELECT COUNT(*) AS total FROM approvedsPr";
    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="President_approve_archives.php" class="sidebar-link">
                        <i class="lni lni-stamp"></i>
                        <span>Approval</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="President_reject_archives.php" class="sidebar-link">
        ...
        <div class="main p-3" >
            <div class="container1 table-responsive">
                <h2 class="titlewrap mb-5 text-center">APPROVES ARCHIVE</h2>
            ...
            <script src="modalQueryA.js"></script>
