<?php
    ...
    $sql = "SELECT * FROM presidentdb LIMIT $start_from, $rows_per_page";
    ...
    $sql_total = "SELECT COUNT(*) AS total FROM presidentdb";
        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="index_president.php" class="sidebar-link">
                            ...
                            while($row = $result->fetch_assoc())  /* CHECK ALL data from table by row */
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class='btn btn-primary btn-sm m-1 fs-5 align-baseline transferBtn' data-id='" . $row['id'] . "' ><i class='bi bi-check2-circle'></i></a> 
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <?php
                            ...
                            if ($current_page > 1) {
                                echo "<li class='page-item'><a class='page-link' href='index_president.php?page=".($current_page - 1)."'>Previous</a></li>";
                            } else {
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                if ($i == $current_page) {
                                    echo "<li class='page-item active'><a class='page-link' href='index_president.php?page=".$i."'>$i</a></li>";
                                } else {
                                    echo "<li class='page-item'><a class='page-link' href='index_president.php?page=".$i."'>$i</a></li>";
                                }
                            }

                            // Next page button
                            if ($current_page < $total_pages) {
                                echo "<li class='page-item'><a class='page-link' href='index_president.php?page=".($current_page + 1)."'>Next</a></li>";
                            } else {
