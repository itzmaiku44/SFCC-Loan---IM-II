...
if (isset($_POST['id'])) {
    ...
    $sql_transfer = "INSERT INTO approvaldb (applicationNumber, fname, lname, age, bmonth, bday, byear, phonenum, email, street1, street2, city, province, postal, country, loanAmount, term, fundPurpose, applyDate, StatusDr)
