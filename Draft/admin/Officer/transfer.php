...
if (isset($_POST['id'])) {
    ...
    $sql_transfer = "INSERT INTO directordb (applicationNumber, fname, lname, age, bmonth, bday, byear, phonenum, email, street1, street2, city, province, postal, country, loanAmount, term, fundPurpose, applyDate, StatusDr)
    ...
    if ($stmt->affected_rows > 0) {
        echo json_encode(["status" => "success", "message" => "Data transferred successfully for approval."]);
    } else {
