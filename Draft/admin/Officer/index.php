<?php
    ...
    $sql = "SELECT * FROM application LIMIT $start_from, $rows_per_page";
    ...
    $sql_total = "SELECT COUNT(*) AS total FROM application";
...
<body style="">
    <div class="wrapper">
        ...
        <div class="main p-3" >
            ...
            <div class="modal fade" id="deleteCaution" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger confirmDeleteBtn">Yes</button>
                        </div>
                    </div>
                </div>
            </div>
