<?php
    ...
    $sql = "SELECT * FROM approveds LIMIT $start_from, $rows_per_page";
    ...
    $sql_total = "SELECT COUNT(*) AS total FROM approveds";
    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="Director_approve_archives.php" class="sidebar-link">
                        <i class="lni lni-stamp"></i>
                        <span>Approval</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="Director_reject_archives.php" class="sidebar-link">
