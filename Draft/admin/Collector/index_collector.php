<?php
    ...
    $sql = "SELECT * FROM collectordb LIMIT $start_from, $rows_per_page";
    ...
    $sql_total = "SELECT COUNT(*) AS total FROM collectordb";
        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="index_collector.php" class="sidebar-link">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <?php
                            ...
                            if ($current_page > 1) {
                                echo "<li class='page-item'><a class='page-link' href='index_collector.php?page=".($current_page - 1)."'>Previous</a></li>";
                            } else {
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                if ($i == $current_page) {
                                    echo "<li class='page-item active'><a class='page-link' href='index_collector.php?page=".$i."'>$i</a></li>";
                                } else {
                                    echo "<li class='page-item'><a class='page-link' href='index_collector.php?page=".$i."'>$i</a></li>";
                                }
                            }

                            // Next page button
                            if ($current_page < $total_pages) {
                                echo "<li class='page-item'><a class='page-link' href='index_collector.php?page=".($current_page + 1)."'>Next</a></li>";
                            } else {
